...
const STRINGS: Dictionary = {
	"fr": {
		...
		# (forge.locked.* supprimées au chantier 12 : l'Atelier est ouvert d'emblée.)
		...
		"expe.legende_position":    "position",
		"expe.legende_accessible":  "accessible",
		"expe.legende_chiffre":     "secteur chiffré",
		...
		# (Les clés building.route.* ont été supprimées au chantier 12 avec le
		# système de routes — quartiers de base ouverts d'emblée.)
		"currency.euren":   "Euren",
		"currency.modules": "Modules",
	...
	"en": {
		...
		"expe.legende_position":    "position",
		"expe.legende_accessible":  "reachable",
		"expe.legende_chiffre":     "encrypted sector",
